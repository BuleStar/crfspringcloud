package com.crfspringcloud.providerusersleuthzipkin;

import com.crfspringcloud.providerusersleuthzipkin.entity.User;
import com.crfspringcloud.providerusersleuthzipkin.repository.UserRepository;
...
public class ProviderUserSleuthZipkinApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ProviderUserSleuthZipkinApplication.class, args);
    }
